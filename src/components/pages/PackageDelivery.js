...
function PackageDelivery() {
    ...
    return (
        ...
        <div className='description-box'>
            ...
            <p><strong>Overview: </strong>This project's main objective was to deliver a set list of 
                ...
                <br/><br/>
                <strong>Technical: </strong>I used a chaining hash table to store package information and a graph 
