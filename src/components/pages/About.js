    ...
    return (
        <>
            ...
            <div className='bio-container'>
                <p>I am currently a Fullstack Software Engineer at Immuta with a primary focus on
                ...
                <br /><br />
                Prior to starting my software engineering career at Immuta, I completed 13 projects and o
                btained 4 certifications. These projects consist of assignments for my bachelor's degree
                program as well as personal projects (including this website). One of my web applications,
                PerfectFit, received the Capstone Certificate of Excellence from WGU for its exemplary work.
                I have created web applications, command-line applications, stand-alone applications,
                and dabbled in AI by creating a chatbot and a robot simulation.
            </p>
            ...
            <div className='bio-container-sm'>
                ...
                making business, <a className="facebook" href="https://www.bogdanreeds.com">Bogdan Reeds</a>. I taught private lessons and master classes at various schools,
            ...
            <div className='bio-container-sm'>
                <h3>I finished my computer science degree in September 2020, and by October, found Immuta. I currently
